    ...
    onMessageMempool(msg) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const txid of msg.txids) {
                object_1.objectManager.retrieve(txid, this).catch(() => {
                    this.sendError(new message_1.AnnotatedError('UNFINDABLE_OBJECT', 'Could not find one of the objects in the mempool'));
                });
            }
        });
    }
